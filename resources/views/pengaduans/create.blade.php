                    ...
                    <div class="card-body">
                        <form action="{{ route('pengaduans.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('nama') is-invalid @enderror" name="nama" value="{{ old('nama') }}" placeholder="Masukkan nama pelapor">
                            ...
                            <div class="form-group">
                                <label class="font-weight-bold">WA</label>
                                <input type="text" class="form-control @error('wa') is-invalid @enderror" name="wa" value="{{ old('wa') }}" placeholder="Masukkan WA Pelapor">
                            
                                <!-- error message untuk wa -->
                                @error('wa')
                                    <div class="alert alert-danger mt-2">
                                        {{ $message }}
                                    </div>
